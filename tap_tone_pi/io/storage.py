...
from .wav import write_wav_mono
...
def analysis_to_json_dict(result: "AnalysisResult") -> dict:
...
def persist_capture(
    *,
    ...
    """Persist a capture and its analysis to disk.

    Creates a timestamped directory with:
    - audio.wav: The captured audio
    - analysis.json: Peak and analysis data
    - spectrum.csv: Frequency/magnitude pairs

    Also appends to session.jsonl in the parent directory.

    Args:
        out_dir: Root output directory
        label: Optional label for this capture point
        sample_rate: Audio sample rate
        audio: Audio data as numpy array
        analysis: AnalysisResult from analyze_tap()

    Returns:
        PersistedCapture with paths to all written files
    """
...
__all__ = ["PersistedCapture", "persist_capture", "analysis_to_json_dict"]
