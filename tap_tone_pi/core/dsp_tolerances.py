...
def assert_amplitude_close(
    measured: float, expected: float, name: str = "amplitude_db"
) -> None:
...
def assert_frequency_close(
    measured: float, expected: float, high_freq: bool = False
) -> None:
