...
class App(tk.Tk):
    ...
    def _setup_quality_measure(self, entry_vars: list) -> tuple:
    ...
    def _save_quality_measure_results(
        self,
        attempt_dir,
        cap,
        result,
    ...
    def _show_quality_verdict_viewer(
        self,
        point_id: str,
        attempt_num: int,
        attempt_dir,
    ...
    def do_quality_measure(self, entry_vars: list[tk.StringVar]) -> None:
        ...
        try:
            ...
            self._save_quality_measure_results(attempt_dir, cap, result, verdict)
