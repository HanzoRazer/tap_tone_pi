...
try:
    from .policy import attach_pattern_record, finalize_run, TOL as CHLADNI_FREQ_TOLERANCE_HZ
except ImportError:
    from modes.chladni.policy import attach_pattern_record, finalize_run, TOL as CHLADNI_FREQ_TOLERANCE_HZ
