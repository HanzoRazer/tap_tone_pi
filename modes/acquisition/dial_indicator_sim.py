...
def main():
    ...
    ap.add_argument(
        "--amp", type=float, default=0.5, help="peak displacement about baseline (unit)"
    )
    ap.add_argument("--baseline", type=float, default=0.0, help="DC offset (unit)")
    ap.add_argument(
        "--noise", type=float, default=0.005, help="white noise std-dev (unit)"
    )
